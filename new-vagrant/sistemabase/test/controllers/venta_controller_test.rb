...
class VentaControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create ventum" do
    assert_difference('Ventum.count') do
      post venta_url, params: { ventum: { cantidad: @ventum.cantidad, cliente: @ventum.cliente, descuento: @ventum.descuento, fecha: @ventum.fecha, monto: @ventum.monto } }
    end
  ...
  test "should update ventum" do
    patch ventum_url(@ventum), params: { ventum: { cantidad: @ventum.cantidad, cliente: @ventum.cliente, descuento: @ventum.descuento, fecha: @ventum.fecha, monto: @ventum.monto } }
