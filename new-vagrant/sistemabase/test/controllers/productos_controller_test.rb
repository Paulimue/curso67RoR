...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { categoria: @producto.categoria, descripción: @producto.descripción, feeling: @producto.feeling, nombre: @producto.nombre, precio: @producto.precio, valoración: @producto.valoración } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { categoria: @producto.categoria, descripción: @producto.descripción, feeling: @producto.feeling, nombre: @producto.nombre, precio: @producto.precio, valoración: @producto.valoración } }
